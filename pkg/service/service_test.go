...
type ManagerTestSuite struct {
	...
	svcHealth *healthserver.MockHealthServerFactory
}
...
func (m *ManagerTestSuite) SetUpTest(c *C) {
	...
	m.svcHealth = healthserver.NewMockHealthServerFactory()
	m.svc.healthServer = healthserver.WithHealthServerFactory(m.svcHealth)
}
